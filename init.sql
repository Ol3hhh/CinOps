...
CREATE TABLE Ticket (
    ...
    user_id INT REFERENCES App_User(id),  -- ВИПРАВЛЕНО: додано підкреслення
...
CREATE TABLE Order_Item (
    id SERIAL PRIMARY KEY,
    order_id INT REFERENCES Food_Order(id) ON DELETE CASCADE, -- ВИПРАВЛЕНО: посилання на Food_Order
